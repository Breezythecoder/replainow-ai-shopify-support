...
import AIOptimizedFAQNl from "@/components/seo/AIOptimizedFAQ.nl";
  ...
  return (
    <>
      ...
      <SEO
        ...
        description="Beantwoord klantenvragen in seconden: GDPR-conform, merkconform, directe Shopify-data. 14 dagen free test."
