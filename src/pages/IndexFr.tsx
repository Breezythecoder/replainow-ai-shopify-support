...
const IndexFr = () => {
  ...
  return (
    <>
      <SEO 
        title="ReplAInow – Helpdesk IA Shopify"
        description="ReplAInow automatise le support client Shopify avec GPT-4.1 : réponses en 3 secondes, 32+ langues, conforme au RGPD, 75% d'économies. Essayez gratuitement dès maintenant !"
