  ...
  return (
    <section className="py-24 bg-gradient-hero text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <p className="text-lg sm:text-xl opacity-90 mb-8 max-w-4xl mx-auto leading-relaxed px-4">Oltre <strong className="text-brand-warning">5000+ commercianti Shopify</strong> usano già ReplAInow. Unisciti all'élite e <strong className="text-brand-warning">schiaccia la concorrenza</strong> con IA superiore.</p>
