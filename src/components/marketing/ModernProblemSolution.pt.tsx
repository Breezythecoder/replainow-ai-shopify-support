    ...
    <section className="py-24 bg-gradient-to-b from-slate-50 to-white">
      <div className="container mx-auto px-6">
        <h2 className="text-4xl font-bold text-center mb-16 tracking-tight">
          ...
          <br />
          <span className="text-brand-success">A solução:</span> IA inteligente
        </h2>
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="bg-destructive/10 border border-destructive/20 rounded-3xl p-8 relative shadow-lg">
            ...
            <img src="/lovable-uploads/1d082320-2e70-4359-aaed-382d72ddacb7.png" alt="Caixa de entrada caótica lotada" className="w-full mb-6 rounded-xl shadow-md" />
            <ul className="space-y-4 text-slate-700">
              ...
              <li className="flex items-center gap-3"><span className="text-destructive text-xl">❌</span><span className="font-medium">Vendas perdidas por mau serviço</span></li>
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-200 rounded-3xl p-8 relative shadow-hero interactive-card">
            ...
            <ul className="space-y-4 text-slate-700">
              ...
              <li className="flex items-center gap-3"><span className="text-brand-success text-xl">✅</span><span className="font-medium">Recomendações perfeitas de produtos</span></li>
              ...
              <li className="flex items-center gap-3"><span className="text-brand-success text-xl">✅</span><span className="font-medium">+187% taxa de conversão</span></li>
              <li className="flex items-center gap-3"><span className="text-brand-success text-xl">✅</span><span className="font-medium">90% menos esforço de suporte</span></li>
            </ul>
          </div>
        </div>
      </div>
