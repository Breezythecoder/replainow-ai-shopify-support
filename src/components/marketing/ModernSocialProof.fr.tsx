...
const ModernSocialProofFr = () => {
  const testimonials = [
    { company: "BeautyStore", owner: "Lisa M.", result: "15 h/semaine gagnées", quote: "ReplAInow a révolutionné notre support. L'IA comprend nos produits mieux que certains employés !", image: testimonialLisa },
    { company: "TechGadgets", owner: "Marco K.", result: "+37% satisfaction client", quote: "Les clients adorent les réponses instantanées. La conversion a explosé !", image: testimonialMarco },
    { company: "FashionHub", owner: "Sarah T.", result: "ROI x12 en 3 mois", quote: "D'Intercom à ReplAInow — meilleur choix ! Moins de coûts, plus de performance.", image: testimonialSarah },
  ];
    ...
    <section className="py-24 bg-gradient-to-b from-slate-50 to-white">
      <div className="container mx-auto px-6">
        <div className="flex flex-wrap justify-center items-center gap-8 mb-16 opacity-70">
          ...
          <span className="px-4 py-2 bg-green-100 text-green-700 rounded-full text-sm font-bold border border-green-200">Conforme RGPD</span>
