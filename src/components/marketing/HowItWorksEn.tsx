      ...
      <div className="container">
        <header className="text-center max-w-3xl mx-auto mb-10 md:mb-14">
          ...
          <p className="text-muted-foreground">
            Install, connect, reply — then automate with rules.
          </p>
        </header>
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <Step Icon={Plug} title="Install" desc="1‑click in the Shopify App Store." />
            <Step Icon={Database} title="Connect" desc="Real‑time access to Shopify data." />
            <Step Icon={Bot} title="Reply" desc="AI suggestions directly in Admin." />
            <Step Icon={Settings2} title="Automate" desc="Rules & auto‑send optional." />
          </div>
        </div>
