    ...
    <section id="live-demo" aria-labelledby="live-demo-heading" className="py-16 md:py-24">
      <div className="container max-w-5xl">
        <h2 id="live-demo-heading" className="font-display text-3xl md:text-4xl font-semibold text-center mb-4">
          This is how ReplAInow works.
        </h2>
        <p className="text-center text-muted-foreground max-w-2xl mx-auto mb-10">
          A customer asks about delivery status — ReplAInow automatically pulls order data from Shopify, crafts an on‑brand answer, and sends it in 3 seconds. Result: happy customer, time saved — and more revenue in parallel.
        </p>
        ...
        <div className="text-center">
          <Button asChild size="lg" variant="hero">
            <a href={OAUTH_URL}>Try it yourself</a>
          </Button>
        </div>
      </div>
    </section>
