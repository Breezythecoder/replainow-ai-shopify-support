      ...
      <div className="container max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <article className="rounded-xl border bg-card p-6 shadow-sm">
            ...
            <ul className="mt-5 space-y-3">
              <Bullet Icon={CheckCircle2}>AI</Bullet>
              <Bullet Icon={Globe}>Shopify</Bullet>
              <Bullet Icon={CheckCircle2}> - </Bullet>
            </ul>

            <ul className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
              <Bullet Icon={CheckCircle2}></Bullet>
              <Bullet Icon={CheckCircle2}>Shopify</Bullet>
              <Bullet Icon={CheckCircle2}>15+</Bullet>
            </ul>
          </article>
          ...
          <article className="rounded-xl border bg-card p-6 shadow-sm">
            ...
            <ul className="mt-5 space-y-3">
              <Bullet Icon={Clock}> - AI</Bullet>
              <Bullet Icon={CheckCircle2}>Shopify - </Bullet>
              <Bullet Icon={CheckCircle2}> - </Bullet>
            </ul>

            <ul className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
              <Bullet Icon={CheckCircle2}>AI - AI</Bullet>
              <Bullet Icon={CheckCircle2}> - </Bullet>
              <Bullet Icon={Globe}> - AI</Bullet>
            </ul>
          </article>
        </div>
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
          <Button asChild size="lg" variant="hero" className="w-full sm:w-auto">
            <a href={OAUTH_URL} aria-label="ReplAInow">ReplAInow</a>
          </Button>
          <Button asChild size="lg" variant="outline" className="w-full sm:w-auto">
            <a href="#live-demo" aria-label=""></a>
          </Button>
        </div>
      </div>
    </section>
