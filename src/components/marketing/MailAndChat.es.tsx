      ...
      <div className="container max-w-6xl">
        <header className="mb-10 text-center">
          ...
          <p className="text-muted-foreground max-w-3xl mx-auto">
            Maneja cada mensaje de cliente instantáneamente en cualquier canal. ReplAInow se conecta a tu tienda Shopify y responde emails
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <article className="rounded-xl border bg-card p-6 shadow-sm">
            ...
            <ul className="mt-5 space-y-3">
              <Bullet Icon={CheckCircle2}>Respuestas IA instantáneas a emails de clientes</Bullet>
              <Bullet Icon={Globe}>Datos Shopify embebidos automáticamente (pedidos, productos, envío)</Bullet>
              <Bullet Icon={CheckCircle2}>Tono multiidioma y conforme a marca – automáticamente</Bullet>
            </ul>

            <ul className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
              <Bullet Icon={CheckCircle2}>Bandeja cero, todos los días</Bullet>
          ...
          <article className="rounded-xl border bg-card p-6 shadow-sm">
            ...
            <figure className="rounded-lg border bg-muted">
              <AspectRatio ratio={16 / 10}>
                <img
                  ...
                  alt="ReplAInow Live Chat – Chat IA en tiempo real en desktop y móvil"
                  loading="lazy"
                  className="h-full w-full object-cover rounded-lg"
                />
              </AspectRatio>
            ...
            <ul className="mt-5 space-y-3">
              <Bullet Icon={Clock}>Soporte de chat completamente automático – IA responde consultas las 24 horas.</Bullet>
              <Bullet Icon={CheckCircle2}>Datos Shopify en tiempo real – info de pedidos y envío, datos de productos, políticas accesibles al instante.</Bullet>
            ...
            <ul className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <Bullet Icon={CheckCircle2}>Categorización y gestión – organizar, etiquetar y priorizar chats.</Bullet>
              <Bullet Icon={Globe}>Soporte multiidioma – IA responde automáticamente en el idioma del cliente.</Bullet>
            </ul>
          </article>
        </div>
