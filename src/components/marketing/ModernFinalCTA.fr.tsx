    ...
    <section className="py-24 bg-gradient-hero text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <p className="text-lg sm:text-xl opacity-90 mb-8 max-w-4xl mx-auto leading-relaxed px-4">
          Plus de <strong className="text-brand-warning">280+ marchands Shopify</strong> utilisent dj ReplAInow. Rejoignez l'lite et <strong className="text-brand-warning">crasez la concurrence</strong> avec une IA suprieure.
        </p>
