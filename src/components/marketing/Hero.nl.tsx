...
import { heroContent as content } from "@/content/hero.nl";
          ...
          <div className="grid md:grid-cols-2 items-center gap-10">
            ...
            <div className="text-center md:text-left order-2 md:order-1">
              ...
              <p className="mt-2 text-sm text-primary-foreground/80">
                In 2 minuten klaar. Zonder creditcard. Zonder risico.
              </p>
              ...
              <div className="mt-5 flex flex-wrap items-center justify-center md:justify-start gap-4 text-sm text-primary-foreground/90">
                <span className="inline-flex items-center gap-2 rounded-full bg-primary-foreground/10 px-3 py-1">
                  <ShieldCheck className="size-4" /> GDPR-conform
                </span>
                <span className="inline-flex items-center gap-2 rounded-full bg-primary-foreground/10 px-3 py-1">
                  <Zap className="size-4" /> Antwoord in seconden
                </span>
                <span className="inline-flex items-center gap-2 rounded-full bg-primary-foreground/10 px-3 py-1">
                  <Plug className="size-4" /> Naadloze Shopify Integr.
                </span>
              </div>
