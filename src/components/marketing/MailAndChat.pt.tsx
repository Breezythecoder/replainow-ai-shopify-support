      ...
      <div className="container max-w-6xl">
        <header className="mb-10 text-center">
          ...
          <p className="text-muted-foreground max-w-3xl mx-auto">
            Lide com cada mensagem do cliente instantaneamente em qualquer canal. ReplAInow se conecta à sua loja Shopify e responde emails
            e mensagens de live chat em menos de 3 segundos – conforme à marca, consciente do contexto e multilíngue.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <article className="rounded-xl border bg-card p-6 shadow-sm">
            ...
            <ul className="mt-5 space-y-3">
              <Bullet Icon={CheckCircle2}>Respostas IA instantâneas para emails de clientes</Bullet>
              <Bullet Icon={Globe}>Dados Shopify incorporados automaticamente (pedidos, produtos, envio)</Bullet>
              <Bullet Icon={CheckCircle2}>Tom multilíngue e conforme à marca – automaticamente</Bullet>
            </ul>
          ...
          <article className="rounded-xl border bg-card p-6 shadow-sm">
            ...
            <ul className="mt-5 space-y-3">
              <Bullet Icon={Clock}>Suporte de chat totalmente automático – IA responde consultas 24 horas por dia.</Bullet>
              <Bullet Icon={CheckCircle2}>Dados Shopify em tempo real – info de pedidos & envio, dados de produtos, políticas acessíveis instantaneamente.</Bullet>
              <Bullet Icon={CheckCircle2}>Visão backend de todos os chats – comerciantes veem todas as conversas em andamento centralmente.</Bullet>
            </ul>
            ...
            <ul className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <Bullet Icon={CheckCircle2}>Categorização & gestão – organizar, etiquetar e priorizar chats.</Bullet>
              <Bullet Icon={Globe}>Suporte multilíngue – IA responde automaticamente no idioma do cliente.</Bullet>
            </ul>
          </article>
        </div>
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
          <Button asChild size="lg" variant="hero" className="w-full sm:w-auto">
            <a href={OAUTH_URL} aria-label="Testar ReplAInow grátis">Testar ReplAInow Grátis</a>
          </Button>
