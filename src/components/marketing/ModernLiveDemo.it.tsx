  ...
  return (
    <section id="live-demo" className="py-24 bg-ultra-light">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="text-lg sm:text-xl text-slate-600 mb-8 sm:mb-12 max-w-3xl mx-auto px-4">Da 0 a eroe in 3 secondi  cos funziona l'IA all'avanguardia per il tuo store Shopify</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 max-w-4xl mx-auto px-4">
          ...
          <div className="glass-card p-6 sm:p-8 rounded-2xl text-center interactive-card hover-lift"><div className="text-3xl sm:text-4xl font-black text-gradient-primary mb-3">24/7</div><div className="text-slate-600 font-medium text-sm sm:text-base">Disponibilit</div></div>
        </div>
      </div>
    </section>
  );
