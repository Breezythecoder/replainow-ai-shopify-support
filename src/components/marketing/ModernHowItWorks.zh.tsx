...
const ModernHowItWorksZh = () => {
  const steps = [
    { step: "01", icon: "⬇️", title: "安装应用", desc: "Shopify 应用商店一键安装" },
    { step: "02", icon: "🔗", title: "自动连接", desc: "AI 自动学习所有产品和政策" },
    { step: "03", icon: "🤖", title: "AI 即刻回复", desc: "3 秒内给出完美答案" },
    { step: "04", icon: "📈", title: "利润飙升", desc: "+187% 转化率，成本下降 75%" },
  ];
  return (
    <section className="py-24 bg-gradient-to-b from-indigo-50 to-purple-50">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black mb-6 sm:mb-8 tracking-tight px-4 text-center">如何 <span className="text-gradient-primary">掌控</span> 客服</h2>
        ...
        <div className="text-center px-4">
          <Button asChild variant="cta" size="xl" className="w-full sm:w-auto text-base sm:text-lg px-8 sm:px-12 py-5 sm:py-6 font-bold min-h-[56px] max-w-md mx-auto"><a href={OAUTH_URL} className="flex items-center justify-center gap-2">🚀 免费开始</a></Button>
          <p className="text-xs sm:text-sm text-slate-500 mt-4 leading-relaxed">✅ 14 天免费 • ✅ 无需设置 • ✅ 随时取消</p>
        </div>
      </div>
    </section>
  );
};
export default ModernHowItWorksZh;