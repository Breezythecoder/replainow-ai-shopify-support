        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <article className="rounded-xl border bg-card p-6 shadow-brand">
            <header className="mb-3">
              ...
              <p className="text-muted-foreground text-sm">La tua AI prende il controllo – in meno di 3 secondi ogni risposta è pronta, con tutte le info ordini e prodotti. Clicchi "Invia". Fatto.</p>
            </header>
            <figure>
