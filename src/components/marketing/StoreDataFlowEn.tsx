...
const Card = ({
  ...
  <div className={`rounded-xl border bg-card p-4 shadow-sm animate-fade-in ${className}`}>
...
const StoreDataFlowEn = () => {
  return (
    <section id="data-context" aria-labelledby="data-context-heading" className="relative py-16 md:py-24 bg-muted/40 overflow-hidden">
      ...
      <div className="container relative">
        <header className="text-center max-w-3xl mx-auto mb-10 md:mb-14">
          <h2 id="data-context-heading" className="font-display text-3xl md:text-4xl font-semibold mb-4">
            Your AI knows your Shopify store — in detail
          </h2>
          ...
          <div className="relative hidden md:block">
            ...
            <div className="absolute inset-0">
              ...
              <div className="absolute -top-4 right-0 w-64">
                <Card Icon={Package} title="Product data" desc="Titles, SKUs, prices, stock" />
              </div>
              <div className="absolute top-1/3 -left-2 w-64">
                <Card Icon={User} title="Customer data" desc="Name, email, order history" />
              </div>
              <div className="absolute top-1/3 -right-2 w-64">
                <Card Icon={FileText} title="Store content" desc="Pages, FAQs, shipping policies" />
              </div>
              ...
              <div className="absolute bottom-0 right-4 w-64">
                <Card Icon={Languages} title="Languages" desc="Preferred languages" />
              </div>
            </div>
          </div>
