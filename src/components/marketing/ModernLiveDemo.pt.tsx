  ...
  return (
    <section id="live-demo" className="py-24 bg-ultra-light">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="text-lg sm:text-xl text-slate-600 mb-8 sm:mb-12 max-w-3xl mx-auto px-4">De 0 a heri em 3 segundos  assim funciona a IA de ponta para sua loja Shopify</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 max-w-4xl mx-auto px-4">
          <div className="glass-card p-6 sm:p-8 rounded-2xl text-center interactive-card hover-lift"><div className="text-3xl sm:text-4xl font-black text-gradient-primary mb-3">3 seg</div><div className="text-slate-600 font-medium text-sm sm:text-base">Tempo mdio de resposta</div></div>
          <div className="glass-card p-6 sm:p-8 rounded-2xl text-center interactive-card hover-lift"><div className="text-3xl sm:text-4xl font-black text-gradient-primary mb-3">98%</div><div className="text-slate-600 font-medium text-sm sm:text-base">Taxa de acurcia</div></div>
