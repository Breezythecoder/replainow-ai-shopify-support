    ...
    >
      ...
      <div className="absolute inset-0 opacity-30">
        <div 
          ...
          style={{
            background: "radial-gradient(circle, rgba(99,102,241,0.4) 0%, rgba(139,92,246,0.2) 30%, transparent 70%)",
            left: `${pos.x - 192}px`,
            top: `${pos.y - 192}px`,
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="space-y-8">
          <h1 className="text-6xl font-black text-gradient-hero leading-tight tracking-tighter">
          ...
          <div className="flex gap-8 text-center">
            <div className="glass-card p-4 rounded-2xl">
              <div className="text-3xl font-black text-gradient-primary">+187%</div>
              <div className="text-sm text-slate-600 font-medium">Conversion</div>
            </div>
            <div className="glass-card p-4 rounded-2xl">
              <div className="text-3xl font-black text-gradient-primary">3 Sek</div>
              <div className="text-sm text-slate-600 font-medium">Antwortzeit</div>
            </div>
            <div className="glass-card p-4 rounded-2xl">
              <div className="text-3xl font-black text-gradient-primary">75%</div>
