    ...
    <section id="about" aria-labelledby="about-heading" className="py-16 md:py-24 bg-muted/40">
      <div className="container max-w-4xl">
        ...
        <p className="text-center text-muted-foreground">
          ReplAInow  um produto da <strong>PrimeVision Group LLC</strong>. Nossa misso: 
          Economizar tempo para comerciantes Shopify e melhorar sustentavelmente as experincias do cliente com tecnologia IA moderna.
        </p>
      </div>
    </section>
  );
