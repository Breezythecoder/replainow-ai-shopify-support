    ...
    <section className="py-24 bg-gradient-to-b from-slate-50 to-white">
      <div className="container mx-auto px-6">
        <h2 className="text-4xl font-bold text-center mb-16 tracking-tight">
          <span className="text-destructive">Le problme :</span> Support dbord
          <br />
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-destructive/10 border border-destructive/20 rounded-3xl p-8 relative shadow-lg">
            ...
            <img 
              ...
              alt="Bote mail surcharge et chaotique" 
            ...
            <ul className="space-y-4 text-slate-700">
              ...
              <li className="flex items-center gap-3">
                <span className="text-destructive text-xl"></span>
                <span className="font-medium">Rponses copies-colles interminables</span>
              </li>
              <li className="flex items-center gap-3">
                <span className="text-destructive text-xl"></span>
              ...
              <li className="flex items-center gap-3">
                <span className="text-destructive text-xl"></span>
                <span className="font-medium">quipe surmene et stresse</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-200 rounded-3xl p-8 relative shadow-hero interactive-card">
            ...
            <img 
              ...
              alt="Tableau de bord ReplAInow avec rponse parfaite" 
              className="w-full mb-6 rounded-xl shadow-md" 
            />
            <ul className="space-y-4 text-slate-700">
              <li className="flex items-center gap-3">
                <span className="text-brand-success text-xl"></span>
                <span className="font-medium">IA rpond automatiquement en 3 secondes</span>
              </li>
              <li className="flex items-center gap-3">
                <span className="text-brand-success text-xl"></span>
