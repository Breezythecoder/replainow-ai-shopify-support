...
const PremiumNavbar = () => {
  ...
  const navItems = [
    { label: t('common.navigation.features'), href: '#features' },
    { label: t('common.navigation.integration'), href: '#integration' },
    { label: t('common.navigation.pricing'), href: '#pricing' },
    { label: t('common.navigation.faq'), href: '#faq' },
  ];
