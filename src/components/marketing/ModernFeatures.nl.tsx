  ...
  return (
    <section id="features" className="py-24 bg-ultra-light">
      <div className="container mx-auto px-4 sm:px-6">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-center mb-8 sm:mb-12 lg:mb-16 tracking-tight px-4">Waarom <span className="text-gradient-primary">ReplAInow</span> beter is</h2>
        <p className="text-lg sm:text-xl text-slate-600 text-center mb-12 sm:mb-16 max-w-4xl mx-auto px-4">Nieuwste GPT-4.1-technologie met perfecte Shopify-integratie</p>
...
export default ModernFeaturesNl;