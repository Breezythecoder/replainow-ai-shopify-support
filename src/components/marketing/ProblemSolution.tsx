      ...
      <div className="container max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          <article className="rounded-xl border bg-card p-6 shadow-sm">
            ...
            <figure>
              <img src="/assets/1d082320-2e70-4359-aaed-382d72ddacb7.png" alt="Shopify-Postfach Screenshot  ReplAInow" className="rounded-lg border w-full" loading="lazy" decoding="async" />
              <figcaption className="sr-only">Vorher: berflltes Postfach</figcaption>
            </figure>
            <p className="mt-4 text-muted-foreground text-sm">
              Tglich 50+ Anfragen, wiederholte Antworten und Datensuche bremsen dein Wachstum.
            </p>
          </article>
