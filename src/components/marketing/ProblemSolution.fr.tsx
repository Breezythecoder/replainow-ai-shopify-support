      ...
      <div className="container max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          <article className="rounded-xl border bg-card p-6 shadow-sm">
            ...
            <figure>
              <img src="/lovable-uploads/1d082320-2e70-4359-aaed-382d72ddacb7.png" alt="Capture d'cran bote Shopify  ReplAInow" className="rounded-lg border w-full" loading="lazy" decoding="async" />
          ...
          <article className="rounded-xl border bg-card p-6 shadow-brand">
            ...
            <figure>
              <img src="/lovable-uploads/91677a2e-50c4-4aeb-8a6e-f6626412e034.png" alt="Bote ReplAInow  Rponse IA dans admin Shopify" className="rounded-lg border w-full" loading="lazy" decoding="async" />
