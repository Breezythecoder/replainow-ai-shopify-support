    ...
    <section id="trust" aria-labelledby="trust-heading" className="py-16 md:py-24 bg-muted/40">
      <div className="container max-w-6xl">
        <h2 id="trust-heading" className="font-display text-3xl md:text-4xl font-semibold text-center mb-4">
          Utilisé et adoré par les principales boutiques Shopify.
        </h2>
        <p className="text-center text-muted-foreground max-w-2xl mx-auto mb-10">
          Plus de confiance. Moins d'effort. Réponses plus rapides.
        </p>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <article className="rounded-xl border bg-card p-6">
            <p className="mb-4">"Nous économisons 15 heures de support par semaine – et nos clients adorent le temps de réponse rapide."</p>
          ...
          <article className="rounded-xl border bg-card p-6">
            <p className="mb-4">"Configuration en minutes, bénéfice immédiat. Nous respectons maintenant nos SLA facilement."</p>
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
          <div className="rounded-xl border bg-card p-6">
            ...
            <div className="text-sm text-muted-foreground">Temps de support économisé par semaine</div>
          </div>
          <div className="rounded-xl border bg-card p-6">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4 text-sm text-muted-foreground">
          ...
          <span className="inline-flex items-center gap-2"><Lock className="size-4" /> Sécurité SSL & HMAC</span>
        </div>
      </div>
    </section>
  );
