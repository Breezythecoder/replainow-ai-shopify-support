const ModernComparisonFr = () => {
  const comparisonData = [
    ["Intelligence IA", "✅ GPT-4.1 Dernier", "❌ IA Basique", "❌ IA Limitée", "❌ IA Ancienne"],
    ["Temps Réponse", "✅ 3 Secondes", "❌ 2-5 Minutes", "❌ 5-10 Minutes", "❌ 10+ Minutes"],
    ["Langues", "✅ 32+ Natives", "❌ 10 Basiques", "❌ 15 Basiques", "❌ 20 Basiques"],
    ["Intégration Shopify", "✅ Sync Temps Réel", "❌ Import Manuel", "❌ Connexion Basique", "❌ Setup Complexe"],
    ["Prix/Mois", "✅ 19€/Mois", "❌ 50€+", "❌ 74€+", "❌ 115€+"],
    ["Temps Setup", "✅ 60 Secondes", "❌ 2-3 Jours", "❌ 1 Semaine", "❌ 2 Semaines"],
    ["Garantie ROI", "✅ 6x Conversion", "❌ Neutre", "❌ Neutre", "❌ Négatif"]
  ];
                  ...
                  <table className="w-full min-w-[600px] sm:min-w-full">
                    <thead>
                      <tr className="border-b border-white/20">
                        <th className="text-left py-4 px-4 sm:py-5 sm:px-6 md:py-6 md:px-8 font-bold text-slate-800 text-sm sm:text-base bg-white/60 rounded-tl-3xl">Fonctionnalité</th>
