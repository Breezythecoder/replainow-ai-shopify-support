      ...
      <div className="container">
        <header className="text-center max-w-3xl mx-auto mb-10 md:mb-14">
          ...
          <p className="text-muted-foreground">
            Installa, connetti, invia risposte – e automatizza con le regole.
          </p>
        </header>
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <Step Icon={Plug} title="Installa" desc="1 clic nello Shopify App Store." />
            <Step Icon={Database} title="Connetti" desc="Accesso in tempo reale ai dati Shopify." />
            <Step Icon={Bot} title="Rispondi" desc="Suggerimenti AI direttamente nell'admin." />
            <Step Icon={Settings2} title="Automatizza" desc="Regole & invio automatico opzionale." />
          </div>
        </div>
        ...
        <div className="text-center max-w-3xl mx-auto mt-10 md:mt-14">
          <div className="mt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
            <Button asChild size="lg" variant="hero" className="w-full sm:w-auto">
              <a href={OAUTH_URL}>Prova gratuita</a>
            </Button>
