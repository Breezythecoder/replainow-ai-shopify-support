...
const ModernSocialProofPt = () => {
  const testimonials = [
    { company: "BeautyStore", owner: "Lisa M.", result: "15 horas/semana economizadas", quote: "ReplAInow revolucionou nosso suporte. A IA entende nossos produtos melhor que alguns funcionários!", image: testimonialLisa },
    { company: "TechGadgets", owner: "Marco K.", result: "+37% satisfação do cliente", quote: "Clientes amam as respostas instantâneas. Conversão disparou!", image: testimonialMarco },
    { company: "FashionHub", owner: "Sarah T.", result: "12x ROI em 3 meses", quote: "De Intercom para ReplAInow — melhor decisão! Custos abaixo, performance acima.", image: testimonialSarah },
  ];
  return (
    <section className="py-24 bg-gradient-to-b from-slate-50 to-white">
      <div className="container mx-auto px-6">
        <div className="flex flex-wrap justify-center items-center gap-8 mb-16 opacity-70">
          ...
          <span className="px-4 py-2 bg-green-100 text-green-700 rounded-full text-sm font-bold border border-green-200">Conforme LGPD</span>
          <span className="px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-bold border border-blue-200">5000+ Lojas</span>
        </div>
