...
const ValuePropositionSection = () => {
  ...
  return (
    <div
      id="features"
      className="relative overflow-hidden bg-gradient-to-b from-purple-50/40 via-white to-white"
    >
      {/* Subtle mesh */}
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-12 md:py-20 relative z-10">
        ...
        <div
          className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-6 md:gap-8"
          ref={statsRef}
        >
                ...
                >
                  ...
                  <div className="inline-block px-6 py-3 bg-white/20 backdrop-blur-xl rounded-full border-2 border-white/30 shadow-xl">
                    <span className="text-sm font-black text-white tracking-wider">
                      {t("marketing.features.valueProposition.automation")}
                    </span>
                  </div>
                </motion.div>
          ...
          >
            ...
            {/* STÄRKERES GLASS */}
            <div
              className="relative rounded-3xl p-8 overflow-hidden h-full group-hover:shadow-float transition-all duration-500 border-2 border-white/60 shadow-xl"
              style={{
              ...
              <div className="relative">
                ...
                <div className="mb-6">
                  <div className="text-5xl md:text-6xl font-black text-gray-900 mb-4 tracking-tight leading-none">
                    {t(
                      "marketing.features.valueProposition.intelligenceMetric"
                    )}
                  </div>
                  <div className="inline-block px-5 py-2.5 rounded-full border-2 border-violet-300 bg-violet-50/80 backdrop-blur-sm shadow-lg">
                    <span className="text-xs font-black text-violet-900 tracking-wider">
                      {t("marketing.features.valueProposition.intelligence")}
                    </span>
                  </div>
                </div>
          ...
          >
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="mb-6">
                  <div className="text-7xl md:text-8xl font-black text-gray-900 mb-4 tracking-tight leading-none">
                    {t(
                      "marketing.features.valueProposition.availabilityMetric"
                    )}
                  </div>
                  <div className="inline-block px-5 py-2.5 rounded-full border-2 border-pink-300 bg-pink-50/80 backdrop-blur-sm shadow-lg">
                    <span className="text-xs font-black text-pink-900 tracking-wider">
                      {t("marketing.features.valueProposition.availability")}
                    </span>
                  </div>
                </div>
