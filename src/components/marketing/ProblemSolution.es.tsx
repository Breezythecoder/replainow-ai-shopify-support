        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          <article className="rounded-xl border bg-card p-6 shadow-sm">
            ...
            <p className="mt-4 text-muted-foreground text-sm">
              Diariamente 50+ consultas, respuestas repetitivas y búsquedas de datos ralentizan tu crecimiento.
            </p>
          </article>

          <article className="rounded-xl border bg-card p-6 shadow-brand">
            <header className="mb-3">
              <h3 className="font-medium text-lg">Después</h3>
              <p className="text-muted-foreground text-sm">Tu IA se hace cargo – en menos de 3 segundos cada respuesta está lista, con toda la info de pedidos y productos. Haces clic en "Enviar". Listo.</p>
            </header>
            <figure>
              ...
              <figcaption className="sr-only">Después: Shopify con respuesta IA</figcaption>
            </figure>
          </article>
        </div>
      </div>
