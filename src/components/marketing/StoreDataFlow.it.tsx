        ...
        <div className="relative max-w-6xl mx-auto">
                ...
                <div className="col-span-2 rounded-lg border bg-background p-4">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="inline-flex items-center gap-2 text-xs text-muted-foreground">
                      <Bot className="h-4 w-4" /> AI attiva
                    </span>
                  </div>
            ...
            <div className="absolute inset-0">
              <div className="absolute -top-4 left-0 w-64">
                <Card
                  Icon={ShoppingCart}
                  title="Dati ordini"
                  desc="ID ordine, stato, articoli, tracking"
                />
              </div>
              <div className="absolute -top-4 right-0 w-64">
                <Card Icon={Package} title="Dati prodotti" desc="Titoli, SKU, prezzi, scorte" />
              </div>
              <div className="absolute top-1/3 -left-2 w-64">
                <Card Icon={User} title="Dati clienti" desc="Nome, email, storico acquisti" />
              </div>
              <div className="absolute top-1/3 -right-2 w-64">
                <Card Icon={FileText} title="Contenuti negozio" desc="Pagine, FAQ, regole spedizione" />
              </div>
              <div className="absolute bottom-0 left-4 w-64">
                <Card Icon={Truck} title="Tracking e spedizioni" desc="Link live, tempi consegna" />
              </div>
              <div className="absolute bottom-0 right-4 w-64">
                <Card Icon={Languages} title="Multilingue" desc="Lingue preferite" />
              </div>
            </div>
          </div>
          ...
          <div className="md:hidden">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Card Icon={ShoppingCart} title="Dati ordini" desc="ID ordine, stato, articoli, tracking" />
              <Card Icon={Package} title="Dati prodotti" desc="Titoli, SKU, prezzi, scorte" />
              <Card Icon={User} title="Dati clienti" desc="Nome, email, storico acquisti" />
              <Card Icon={FileText} title="Contenuti negozio" desc="Pagine, FAQ, regole spedizione" />
              <Card Icon={Truck} title="Tracking e spedizioni" desc="Link live, tempi consegna" />
