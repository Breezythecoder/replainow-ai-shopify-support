  ...
  return (
    <section className="py-24 bg-gradient-hero text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <p className="text-lg sm:text-xl opacity-90 mb-8 max-w-4xl mx-auto leading-relaxed px-4">Meer dan <strong className="text-brand-warning">5000+ Shopify-winkels</strong> gebruiken ReplAInow. Word elite en <strong className="text-brand-warning">overtref de concurrentie</strong> met superieure AI.</p>
