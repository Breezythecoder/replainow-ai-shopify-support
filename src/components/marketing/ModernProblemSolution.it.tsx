      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="bg-destructive/10 border border-destructive/20 rounded-3xl p-8 relative shadow-lg">
            ...
            <img src="/assets/1d082320-2e70-4359-aaed-382d72ddacb7.png" alt="Casella email caotica e piena" className="w-full mb-6 rounded-xl shadow-md" />
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-200 rounded-3xl p-8 relative shadow-hero interactive-card">
            ...
            <img src="/assets/91677a2e-50c4-4aeb-8a6e-f6626412e034.png" alt="Dashboard ReplAInow con risposta perfetta" className="w-full mb-6 rounded-xl shadow-md" />
            <ul className="space-y-4 text-slate-700">
