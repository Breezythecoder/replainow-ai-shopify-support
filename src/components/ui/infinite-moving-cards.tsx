/**
 * 🎡 Infinite Moving Cards - Aceternity UI Style
 * Auto-scrolling cards for testimonials
 */
  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-gray-200 px-8 py-6 md:w-[450px] bg-white shadow-lg"
            key={idx}
          >
            <blockquote>
              <div
